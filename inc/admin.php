...
class Admin {
    ...
    private function welcome_notification() {
        ...
        // phpcs:ignore
        if (isset($_GET['marmot-complete-wellcome']) && $_GET['marmot-complete-wellcome']) {
            set_theme_mod('marmot_wellcome_hide', 1);
        }

        $setup_hide = get_theme_mod('marmot_wellcome_hide', 0);
        ...
        if (isset($_GET['page']) && in_array($_GET['page'], [THEME_SLUG])) {
            return;
        }
...
// phpcs:enable
    ...
    public function admin_enqueue_scripts() {
        if (!isset($_GET['page']) || !in_array($_GET['page'], [THEME_SLUG, THEME_SLUG . '-theme-setup', THEME_SLUG . '-ready-sites', THEME_SLUG . '-theme-options'])) {
            return;
        }
